...
----Creación de la tabla pago_reventa--
create table pago_reventa(
...
alter table pago_reventa
	add constraint FK_pago_reventa foreign key (codigo_reventa)
	references reventa_pesca (codigo_reventa)
	on delete restrict on update restrict;